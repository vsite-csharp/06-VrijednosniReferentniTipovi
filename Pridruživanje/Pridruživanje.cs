...
namespace Vsite.CSharp.VrijednosniReferentniTip
{
    ...
    class Pridruživanje
    {
        public static void PridruživanjeStruktura(int prvaVrijednost, int drugaVrijednost)
        {
            ...
            // TODO:002 Dodati dvije naredbe koje će ponovno ispisati vrijednosti članova vt1.X, odnosno vt2.X. Pokrenuti program i provjeriti ispis
        ...
        public static void PridruživanjeKlasa(int prvaVrijednost, int drugaVrijednost)
        {
            ...
            RefTip rt2 = rt1;
            // TODO:004 Dodati dvije naredbe koje će ispisati vrijednosti članova rt1.X, odnosno rt2.X
            ...
            // TODO:005 Dodati dvije naredbe koje će ponovno ispisati vrijednosti članova rt1.X, odnosno rt2.X. Pokrenuti program i provjeriti ispis
        ...
        public static void PridruživanjeNovogObjektaČlanuPreslikaneStukture(int prvaVrijednost, int drugaVrijednost)
        {
            ...
            // TDO:009 Otkomentirati donje naredbe, ponoviti naredbe za ispis vrijednosti članova vt1.Rt.X, odnosno vt2.Rt.X. Pokrenuti program i provjeriti ispis
            vt1.Rt = new RefTip();
            vt1.Rt.X = prvaVrijednost;
            Console.WriteLine(vt1.Rt.X);
            Console.WriteLine(vt2.Rt.X);
