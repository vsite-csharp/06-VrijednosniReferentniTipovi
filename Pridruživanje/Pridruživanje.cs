...
namespace Vsite.CSharp.VrijednosniReferentniTip
{
    ...
    class Pridruživanje
    {
        ...
        {
            VrijednTip vt1 = new VrijednTip();   //referentni na heap(možemo ih proširiti jer su na heapu pa možemo izvoditi) vrijednosni na stack
            vt1.X = prvaVrijednost;

            // Deklarirati novi objekt "vt2" tipa VrijednTip i pridružiti mu vrijednost objekta "vt1"
            VrijednTip vt2 = vt1;
            ...
            // Dodati dvije naredbe koje će ponovno ispisati vrijednosti članova vt1.X, odnosno vt2.X. Pokrenuti program i provjeriti ispis
        ...
        public static void PridruživanjeKlasa(int prvaVrijednost, int drugaVrijednost)
        {
            ...
            //  Deklarirati novi objekt "rt2" RefTip i pridružiti mu objekt "rt1"
            RefTip rt2 = rt1;
            ...
            //  Dodati dvije naredbe koje će ponovno ispisati vrijednosti članova rt1.X, odnosno rt2.X. Pokrenuti program i provjeriti ispis
            Console.WriteLine(rt1.X);
            Console.WriteLine(rt2.X);

            //KLASA IDE PO REFERENCI 
        }
        ...
        public static void PridruživanjeNovogObjektaČlanuPreslikaneStukture(int prvaVrijednost, int drugaVrijednost)
        {
            ...
            // Deklarirati novi objekt "vt2" tipa VrijednTip i pridružiti mu objekt "vt1"

            VrijednTip vt2 = vt1;

            //  Dodati naredbe koje će ispisati vrijednosti članova vt1.Rt.X, odnosno vt2.Rt.X
            ...
            //  Dodati dvije naredbe koje će ponovno ispisati vrijednosti članova vt1.Rt.X, odnosno vt2.Rt.X. Pokrenuti program i provjeriti ispis
            Console.WriteLine(vt1.Rt.X);   //ISTE VRIJEDNOSTI
            Console.WriteLine(vt2.Rt.X);

            Console.WriteLine($"Članu vt1.Rt pridružujemo novi objekt i zadajemo da je vt1.Rt.X={prvaVrijednost}:");

            // Otkomentirati donje naredbe, ponoviti naredbe za ispis vrijednosti članova vt1.Rt.X, odnosno vt2.Rt.X. Pokrenuti program i provjeriti ispis
            vt1.Rt = new RefTip();
            vt1.Rt.X = prvaVrijednost;

            Console.WriteLine(vt1.Rt.X);  //RAZLIČITE VRIJEDNOSTI
            Console.WriteLine(vt2.Rt.X);
        }
