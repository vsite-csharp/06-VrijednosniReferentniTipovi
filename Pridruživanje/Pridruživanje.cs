...
namespace Vsite.CSharp.VrijednosniReferentniTip
{
    ...
    class Pridruživanje
    {
        public static void PridruživanjeStruktura(int prvaVrijednost, int drugaVrijednost)
        {
            ...
            // Dodati naredbe koje će ispisati vrijednosti članova vt1.X, odnosno vt2.X
            ...
            // Ponoviti naredbe za ispis vrijednosti članova vt1.X, odnosno vt2.X. Pokrenuti program i provjeriti ispis
            Console.WriteLine(vt1.X);
            Console.WriteLine(vt2.X);
        }
        ...
        public static void PridruživanjeKlasa(int prvaVrijednost, int drugaVrijednost)
        {
            ...
            // Dodati naredbe koje će ispisati vrijednosti članova rt1.X, odnosno rt2.X
            ...
            // Ponoviti naredbe za ispis vrijednosti članova rt1.X, odnosno rt2.X. Pokrenuti program i provjeriti ispis
            Console.WriteLine(rt1.X);
            Console.WriteLine(rt2.X);
        }
        ...
        public static void PridruživanjeNovogObjektaČlanuPreslikaneStukture(int prvaVrijednost, int drugaVrijednost)
        {
            ...
            // Ponoviti naredbe za ispis vrijednosti članova vt1.Rt.X, odnosno vt2.Rt.X. Pokrenuti program i provjeriti ispis
            Console.WriteLine(vt1.Rt.X);
            Console.WriteLine(vt2.Rt.X);
        ...
        // Pokrenuti testove i provjeriti prolaze li sva 3 testa u grupi TestPridruživanja.
