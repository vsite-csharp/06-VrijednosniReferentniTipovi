namespace Vsite.CSharp.VrijednosniReferentniTip
{
    ...
    class Pridruživanje
    {
        public static void PridruživanjeStruktura(int prvaVrijednost, int drugaVrijednost)
        {
            ...
            var vt2 = new VrijednTip();
            vt2 = vt1;
            // :020 Deklarirati novi objekt "vt2" tipa VrijednTip i pridružiti mu vrijednost objekta "vt1"
            Console.WriteLine(vt1.X);
            Console.WriteLine(vt2.X);

            // :021 Dodati naredbe koje će ispisati vrijednosti članova vt1.X, odnosno vt2.X
            ...
            Console.WriteLine(vt1.X);
            Console.WriteLine(vt2.X);
            // :022 Ponoviti naredbe za ispis vrijednosti članova vt1.X, odnosno vt2.X. Pokrenuti program i provjeriti ispis.
        ...
        public static void PridruživanjeKlasa(int prvaVrijednost, int drugaVrijednost)
        {
            ...
            var rt2 = new RefTip();
            rt2 = rt1;
            // :023 Deklarirati novi objekt "rt2" RefTip i pridružiti mu objekt "rt1".

            Console.WriteLine(rt1.X);
            Console.WriteLine(rt2.X);
            // :024 Dodati naredbe koje će ispisati vrijednosti članova rt1.X, odnosno rt2.X.
            ...
            Console.WriteLine(rt1.X);
            Console.WriteLine(rt2.X);
            // :025 Ponoviti naredbe za ispis vrijednosti članova rt1.X, odnosno rt2.X. Pokrenuti program i provjeriti ispis.
        ...
        public static void PridruživanjeNovogObjektaČlanuPreslikaneStukture(int prvaVrijednost, int drugaVrijednost)
        {
            ...
            var vt2 = new VrijednTip();
            vt2 = vt1;
            // :026 Deklarirati novi objekt "vt2" tipa VrijednTip i pridružiti mu objekt "vt1".

            Console.WriteLine(vt1.Rt.X);
            Console.WriteLine(vt2.Rt.X);

            // :027 Dodati naredbe koje će ispisati vrijednosti članova vt1.Rt.X, odnosno vt2.Rt.X.
            ...
            Console.WriteLine(vt1.Rt.X);
            Console.WriteLine(vt2.Rt.X);
            // :028 Ponoviti naredbe za ispis vrijednosti članova vt1.Rt.X, odnosno vt2.Rt.X. Pokrenuti program i provjeriti ispis.


            Console.WriteLine($"Članu vt1.Rt pridružujemo novi objekt i zadajemo da je vt1.Rt.X={prvaVrijednost}:");

            // :029 Otkomentirati donje naredbe, ponoviti naredbe za ispis vrijednosti članova vt1.Rt.X, odnosno vt2.Rt.X. Pokrenuti program i provjeriti ispis.
            vt1.Rt = new RefTip();
            vt1.Rt.X = prvaVrijednost;
        ...
        // :029a Pokrenuti testove i provjeriti prolaze li sva 3 testa u grupi TestPridruživanja.
