...
namespace Vsite.CSharp.VrijednosniReferentniTip
{
    ...
    class UtjecajGCa
    {
        ...
        {
            // DID_IT:030 Ponoviti kod prethodne metode ali za inicijalizaciju objekata tipa MojaKlasa
        ...
        {
            // DID_IT:031 Ponoviti kod gornje metode ali za inicijalizaciju objekata tipa MojaKlasa

            // DID_IT:032 Provjeriti prolaze li svi testovi iz grupe TestUtjecajaGCa
            var tikovi = new long[brojPonavljanja, 2];
            Stopwatch sw = new Stopwatch();
